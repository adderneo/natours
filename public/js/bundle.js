    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); //true is imp for server reload
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWRkZXItbmVvIiwiYSI6ImNrZndyc241czA3M2Uyd3FkeGRrN3FsNW4ifQ.uqAlBEw0sXgqn-5_L0UCEg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/adder-neo/ckfwsfw9g6aml19nrszwds8n6',
    scrollZoom: false // center: [-118.550473, 34.228203],
    // zoom: 8,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 40
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend the map bounds to include currect locations
...
var stripe = Stripe('pk_test_51Hb9S0DwBpAeFUH1Jt7YmJyxODZoYDniaL7ONVzROCkAYZEBxkdTPAJefLbcE3GHzihfzDHX9lYTR2vuIch5e48P00gJhwWNkC');
...
if (userDataPassword) {
  userDataPassword.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btm--save-password').textContent = 'Updating...';
            ...
            case 7:
              document.querySelector('.btm--save-password').textContent = 'SAVE PASSWORD';
